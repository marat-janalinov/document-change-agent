...
1. **ПРОЧИТАЙ ВЕСЬ ДОКУМЕНТ** - не останавливайся на первой инструкции!
2. **ПОДСЧИТАЙ КОЛИЧЕСТВО ИНСТРУКЦИЙ** - каждая инструкция = отдельное изменение
3. **ВЕРНИ ВСЕ ИНСТРУКЦИИ** - если инструкций несколько (2, 3, 5...), ВСЕ должны быть в массиве `changes`
4. **НЕ ПРЕРЫВАЙСЯ** - если видишь несколько инструкций, продолжай до конца документа
...
**ПОМНИ**: Одна инструкция = один объект в массиве. Если в документе 3 инструкции, в массиве должно быть 3 объекта (CHG-001, CHG-002, CHG-003).
