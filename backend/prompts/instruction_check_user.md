...
**КРИТИЧЕСКИ ВАЖНО - ПРОЦЕСС АНАЛИЗА**:

**ШАГ 1: ПРОЧИТАЙ ВЕСЬ ДОКУМЕНТ ОТ НАЧАЛА ДО КОНЦА**
- Не останавливайся на первой найденной инструкции!
- Просмотри весь документ построчно
- Найди ВСЕ инструкции, независимо от их количества

**ШАГ 2: ПОДСЧИТАЙ ИНСТРУКЦИИ**
- Посчитай количество инструкций вручную
- Каждая инструкция = отдельное изменение (CHG-001, CHG-002, CHG-003...)
- Если видишь "1.", "2.", "3." - это отдельные инструкции
- Если видишь "CHG-001", "CHG-002" - это отдельные инструкции

**ШАГ 3: СОЗДАЙ JSON С ВСЕМИ ИНСТРУКЦИЯМИ**
- Если инструкций несколько (2, 3, 5...) - ВСЕ должны быть в массиве `changes`
- НЕ возвращай только первую инструкцию!
- НЕ останавливайся на первом найденном изменении!
- Каждая инструкция = отдельный объект с уникальным change_id

**ПРИМЕР: Если в документе 5 инструкций, в ответе должно быть:**
```json
{
  "changes": [
    {"change_id": "CHG-001", ...},
...
**НЕ ДОПУСТИМО возвращать только:**
```json
{
  "changes": [
    {"change_id": "CHG-001", ...}
...
1. ✅ Прочитай весь документ инструкций ОТ НАЧАЛА ДО КОНЦА
2. ✅ Подсчитай количество инструкций (изменений) в документе ВРУЧНУЮ
...
5. ✅ НЕ останавливайся на первой инструкции - продолжай чтение до конца документа!
