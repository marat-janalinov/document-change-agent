...
- **Пользователь**: `operator1` / `operator123` *(с тестовыми файлами)*
...
Для быстрого знакомства с системой в учетной записи **`operator1`** предустановлены тестовые файлы:

**📁 В папке source/ (исходные документы):**
- Тестовый Word документ для демонстрации функционала

**📝 В папке changes/ (файлы с инструкциями):**
- Тестовый файл с инструкциями для обработки документа
- Несколько дополнительных файлов с различными типами инструкций
- Примеры для тестирования функции "Проверка инструкций"

**Рекомендация:** Начните работу с учетной записи `operator1`, чтобы сразу протестировать все функции системы с готовыми примерами.
...
В учетной записи **`operator1`** доступны готовые файлы для тестирования:
- Файлы с различными типами инструкций
- Примеры массовых замен
- Образцы сложных операций (вставка таблиц, разделов)
- Файлы для демонстрации всех поддерживаемых операций

**Совет:** Используйте эти файлы для изучения возможностей системы перед созданием собственных инструкций.
...
- Шаблоны инструкций
- *В учетной записи operator1: готовые тестовые файлы*
